...
- Name: 01-authentication.spec.ts >> Feature 11: Authentication (WebAuthn) >> registered user can log out and login again
- Location: tests/01-authentication.spec.ts:29:7
