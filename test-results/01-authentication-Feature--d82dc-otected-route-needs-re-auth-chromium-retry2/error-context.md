...
- Name: 01-authentication.spec.ts >> Feature 11: Authentication (WebAuthn) >> logout clears session - protected route needs re-auth
- Location: tests/01-authentication.spec.ts:52:7
