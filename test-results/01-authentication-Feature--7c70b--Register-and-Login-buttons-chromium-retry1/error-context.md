...
- Name: 01-authentication.spec.ts >> Feature 11: Authentication (WebAuthn) >> login page loads with Register and Login buttons
- Location: tests/01-authentication.spec.ts:15:7
