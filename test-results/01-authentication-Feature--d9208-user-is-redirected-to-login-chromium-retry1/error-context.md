...
- Name: 01-authentication.spec.ts >> Feature 11: Authentication (WebAuthn) >> unauthenticated user is redirected to /login
- Location: tests/01-authentication.spec.ts:5:7
